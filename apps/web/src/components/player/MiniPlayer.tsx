...
export function MiniPlayer() {
  const { currentTrack, status, togglePlayPause, skipNext, setExpanded } = usePlayerStore()

  if (!currentTrack) return null

  return (
    <div
      className="glass fixed bottom-16 left-0 right-0 mx-3 rounded-2xl px-4 py-3 flex items-center gap-3 cursor-pointer z-40"
